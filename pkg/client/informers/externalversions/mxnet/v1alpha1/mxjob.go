...
import (
	...
	mxnet_v1alpha1 "github.com/kubeflow/tf-operator/pkg/apis/mxnet/v1alpha1"
	...
	v1alpha1 "github.com/kubeflow/tf-operator/pkg/client/listers/mxnet/v1alpha1"
...
func (f *mXJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mxnet_v1alpha1.MXJob{}, f.defaultInformer)
}
